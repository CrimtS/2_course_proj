...
import 'package:mw_inside/pages/loginPage.dart';
import 'package:mw_inside/pages/profilePage.dart';
import 'package:mw_inside/pages/signUpPage.dart';
...
class _UserPageState extends State<UserPage> {
  ...
  Future<String> setPage() async {
    ...
    if (currentPageName == 'login') {
      ...
      currentPage = SignUpPage(onLogInButtonPressed: () {
        setState(() {
          currentPageName = 'login';
        });
      });
