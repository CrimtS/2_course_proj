...
import 'package:mw_inside/components/bottomAppBar.dart';
import 'package:mw_inside/components/mainLoadingPage.dart';
import 'package:mw_inside/pages/userPage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (loading) {
      ...
      if (!loggedIn) {
        ...
        return MaterialApp(
          home: LocationPermissionErrorPage(),
        );
      }
    }
